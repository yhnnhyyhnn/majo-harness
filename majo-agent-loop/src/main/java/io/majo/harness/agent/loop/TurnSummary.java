...
public final class TurnSummary implements SessionProjection {
    ...
    public void onEvent(String sessionId, TypedSessionEvent event) {
        ...
        Summary next = switch (event) {
            ...
            case TypedSessionEvent.ApprovalRequested ignored -> current;
            case TypedSessionEvent.ApprovalDecided ignored -> current;
            case TypedSessionEvent.TodoSet ignored -> current;
            case TypedSessionEvent.PlanSet ignored -> current;
            case TypedSessionEvent.ScheduleSet ignored -> current;
