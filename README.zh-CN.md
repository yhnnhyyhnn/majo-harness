...
java -jar majo-web/target/majo-web-0.7.0.jar          # http://localhost:8787（web.yml；默认绑 127.0.0.1）
java -jar majo-web/target/majo-web-0.7.0.jar --profile web-mock   # 离线（mock llm）
```
