...
文档：[架构](docs/architecture.zh-CN.md) · [architecture (EN)](docs/architecture.md) · [web 对齐](docs/web-parity.zh-CN.md) · [插件开发](docs/plugin-development.zh-CN.md) · [plugin development (EN)](docs/plugin-development.md) · [changelog](CHANGELOG.md)
