...
java -jar majo-web/target/majo-web-0.6.2.jar          # http://localhost:8787 (web.yml, binds 127.0.0.1)
java -jar majo-web/target/majo-web-0.6.2.jar --profile web-mock   # offline (mock llm)
```
