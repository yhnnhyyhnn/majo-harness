...
java -jar majo-web/target/majo-web-0.2.0.jar          # http://localhost:8787 (web.yml, binds 127.0.0.1)
java -jar majo-web/target/majo-web-0.2.0.jar --profile web-mock   # offline (mock llm)
```
