...
<p align="left">
  ...
  <img alt="modules" src="https://img.shields.io/badge/modules-33-blue">
  <img alt="tools" src="https://img.shields.io/badge/tools-20-green">
</p>
...
Docs: [architecture](docs/architecture.md) · [中文架构](docs/architecture.zh-CN.md) · [web 对齐](docs/web-parity.md) · [plugin development](docs/plugin-development.md) · [中文插件开发](docs/plugin-development.zh-CN.md) · [changelog](CHANGELOG.md) · [verification](docs/verification.md) · [roadmap 0.2](docs/roadmap-0.2.md)
...
java -jar majo-cli/target/majo-cli-0.7.0.jar "1+2"
```
...
java -jar majo-web/target/majo-web-0.7.0.jar          # http://localhost:8787 (web.yml, binds 127.0.0.1)
java -jar majo-web/target/majo-web-0.7.0.jar --profile web-mock   # offline (mock llm)
```
...
```bash
java -jar majo-web/target/majo-web-0.7.0.jar --port 8899 --profile web-mock
